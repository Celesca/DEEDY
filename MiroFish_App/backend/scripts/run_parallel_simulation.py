...
def get_active_agents_for_round(
    ...
    peak_hours = time_config.get("peak_hours", [18, 19, 20, 21, 22, 23, 0])  # 泰国作息默认值
    off_peak_hours = time_config.get("off_peak_hours", [1, 2, 3, 4, 5])  # 泰国作息默认值
...
async def run_twitter_simulation(
    ...
    for round_num in range(total_rounds):
        ...
        await asyncio.sleep(1.5)  # Prevent hitting OpenRouter rate limit
