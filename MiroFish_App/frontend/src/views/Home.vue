<template>
  <div class="home-container">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand">THAI SOCIETY SIMULATOR</div>
      <div class="nav-links">
        <LanguageSwitcher />
        <a href="https://github.com/Celesca/DEEDY" target="_blank" class="github-link">
      ...
      <section class="hero-section">
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <h1 style="font-size: 3rem; font-weight: bold; color: var(--primary-color);">THAI SOCIETY<br/>SIMULATOR</h1>
          </div>
