...
To isolate
the social mechanism from language generation, a separate sweep used 500
public agents under each feed--network combination. Table~\ref{tab:mechanism}
shows that the graph assumption changed participation and diffusion much more
than the ranking policy: the matched-random graph reached almost the entire
population, whereas the post-affiliation proxy reached less than half.
